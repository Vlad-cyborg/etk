    ...
    <div class = "image">
        <?php if ($product->image){?>
            <div class="image_block">
                ...
                <?php }?>
                <a href="<?php print $product->product_link?>">
                    <img class="jshop_img lazy" data-src="<?php print $product->image?>" alt="<?php print htmlspecialchars($product->name);?>" title="<?php print htmlspecialchars($product->name);?>"  />
                </a>
            </div>
        <?php }?>
    ...
    <div class = "oiproduct">
        ...
        <?php if ($product->_display_price){
            ...
            <div class = "jshop_price">
                ...
                <span><?php print $price;?><?php print $product->_tmp_var_price_ext;?></span>
            </div>
        <?php }?>
        ...
        <?php if (is_array($product->extra_field)){?>
            <div class="extra_fields">
                <?php foreach($product->extra_field as $extra_field){?>
                    <div class="extra_fields_description">
