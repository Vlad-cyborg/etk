    ...
    <div class="jshop address_block">
        ...
        <form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" class = "form-horizontal" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class = "jshop_register">
              	<h2 class="jshop_placing_order"><?php print _JSHOP_PLACING_AN_ORDER_TITLE ?></h2>
                ...
                <div class = "control-group">
                    ...
                    <div class = "controls">
                    <input type = "text" onkeypress="validate(event)" name = "firma_name" id = "firma_name" value = "<?php print $this->user->firma_name ?>" class = "input" />
                    </div>
                </div>
              <script>
                ...
                <div class = "control-group">
                    ...
                    <div class = "controls">
                    <input type = "text" onkeypress="validate(event)" name = "apartment" id = "apartment" value = "<?php print $this->user->apartment ?>" class = "input" />
                    </div>
                </div>
                <?php } ?>        
