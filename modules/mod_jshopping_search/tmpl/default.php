...
<input type = "text" class = "inputbox" placeholder="Поиск по каталогу" style = "width: 110px" name = "search" id = "jshop_search" value = "<?php print $search?>" />
<input class = "buttonsearch" type = "submit" value = "<?php print "Искать"?>" />
<?php if ($adv_search) {?>
